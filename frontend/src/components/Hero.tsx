      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2 text-foreground">Best Yields</h3>
            <p className="text-muted-foreground">Find the highest APY opportunities across 50+ protocols</p>
          </div>
          <div className="text-center">
            <Shield className="h-12 w-12 mx-auto mb-4 text-primary" />
            <h3 className="text-lg font-semibold mb-2 text-foreground">Risk Analysis</h3>
            <p className="text-muted-foreground">Smart contract audits and risk scoring for every pool</p>
          </div>
          <div className="text-center">
            <Zap className="h-12 w-12 mx-auto mb-4 text-primary" />
            <h3 className="text-lg font-semibold mb-2 text-foreground">Auto-Compound</h3>
